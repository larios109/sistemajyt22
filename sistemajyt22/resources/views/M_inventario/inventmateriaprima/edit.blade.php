        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Cantidad</label>
                 <div class="col-sm-7">
                    <input type="number" id="cantidad" name="cantidad" min="2" max="300000" class="form-control" placeholder="Ingrese la Cantidad" value="{{$inventmateriap->can_Compra}}">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Precio Compra</label>
                 <div class="col-sm-7">
                    <input type="number" id="precio" name="precio" min="2" max="3000" class="form-control" placeholder="Ingrese el precio de compra" value="{{$inventmateriap->pre_compra}}">
                </div>
