        ...
        <div class="card  mb-2">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Descripcion</label>
                 <div class="col-sm-7">
                    <input type="text" id="Descripcion" name="Descripcion" class="form-control" placeholder="Ingrese la descripcion">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Precio Compra Materia</label>
                 <div class="col-sm-7">
                    <input type="number" id="Precio" name="Precio" min="2" max="2000" class="form-control" placeholder="Ingrese el Precio">
                </div>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Tipo de Medida</label>
                 <div class="col-sm-7">
                    <input type="text" id="Medida" name="Medida"  class="form-control" placeholder="Ingrese la medida">
                </div>
