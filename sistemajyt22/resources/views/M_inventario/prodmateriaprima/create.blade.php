...
@section('title', '| Crear producto materia prima')
...
@section('content')
    <form action="{{route('productomateriaprima.store')}}" method='POST'>
        @csrf
        <div class="card  mb-2">
            <div  class="row mb-3">
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Cantidad Materia Requerida</label>
                 <div class="col-sm-7">
                    <input type="number" id="Cantidad" name="Cantidad" min="2" max="5000" class="form-control" placeholder="Ingrese la cantidad">
                </div>
