...
@section('title', '| Crear Datos empleado')
        ...
        <div class="card  mb-2">
            <div  class="row mb-3">
                ...
                <select class="col-sm-7" class="form-control" id="empleado" name="empleado">
                    <option selected>Escoja un codigo de empleado</option>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">DNI</label>
                 <div class="col-sm-7">
                    <input type="number" id="DNI" name="DNI"  maxlength="13" class="form-control" placeholder="Ingrese el dni">
                </div>
                @if ($errors->has('DNI'))
                    <div               
                        id="DNI-error"                               
            ...
            <div  class="row mb-3">
                ...
                <select class="col-sm-7" class="form-control" id="ROL" name="ROL">
                    <option selected>Escoja un codigo de un rol</option>
            ...
            <div class="row mb-3">
                <label for="colFormLabel" class="col-sm-2 col-form-label">Numero Telefono</label>
                 <div class="col-sm-7">
                    <input type="number" id="Telefono" name="Telefono" min="2" max="10000000" class="form-control" placeholder="Ingrese el numero de telefono">
                </div>
