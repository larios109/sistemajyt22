...
class pagosalarioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('M_empleados.pagosalario.index')->with('pagosaalario', json_decode($response,true));
    }
    ...
    public function create()
    {
        ...
        return view('M_empleados.pagosalario.create')->with('users', json_decode($response,true));
    }
    ...
    public function store(Request $request)
    {
        ...
        $response2 = Http::get('http://localhost:3000/pago_salario');
        return view('M_empleados.pagosalario.index')->with('pagosaalario', json_decode($response2,true));
    }
    ...
    public function edit($cod_pago)
    {
        ...
        return view('M_empleados.pagosalario.edit',['pagosalarioactu'=>$pagosalarioactu])
