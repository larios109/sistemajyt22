...
class direccionclienteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::post('http://localhost:3000/direccion_cliente/insertar', [
            ...
            'direccion_telefono' => $request->Telefono
        ]);

        $response2 = Http::get('http://localhost:3000/direccion_cliente');
        return view('M_cliente.direccioncliente.index')->with('direccioncliente', json_decode($response2,true));
    }
